...
import { ideasBySession as seedIdeasBySession, allSeedSessions as seedRecentSessions } from "./mocks.js?v=1163";
...
import { postExtractionResult, startPending, finishPending } from "./assistant.js?v=1163";
import { setIdeasReader } from "./assistant.js?v=1163";
