...
import { ideasBySession as seedIdeasBySession, allSeedSessions as seedRecentSessions } from "./mocks.js?v=1208";
...
import { postExtractionResult, startPending, finishPending } from "./assistant.js?v=1208";
import { setIdeasReader } from "./assistant.js?v=1208";
