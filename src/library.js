...
import { ideasBySession as seedIdeasBySession, allSeedSessions as seedRecentSessions } from "./mocks.js?v=1181";
...
import { postExtractionResult, startPending, finishPending } from "./assistant.js?v=1181";
import { setIdeasReader } from "./assistant.js?v=1181";
