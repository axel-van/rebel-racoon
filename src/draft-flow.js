...
import { postAssistantChoice, startPending, finishPending, postDraftResult } from "./assistant.js?v=68";
import { getIdeas } from "./library.js?v=62";
import { ideas as GLOBAL_IDEAS, anglesByIdea } from "./mocks.js?v=67";
