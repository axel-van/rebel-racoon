...
import { postAssistantChoice, startPending, finishPending, postDraftResult } from "./assistant.js?v=104";
import { getIdeas } from "./library.js?v=98";
import { ideas as GLOBAL_IDEAS, anglesByIdea } from "./mocks.js?v=96";
