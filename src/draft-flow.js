...
import { postAssistantChoice, startPending, finishPending, postDraftResult } from "./assistant.js?v=100";
import { getIdeas } from "./library.js?v=94";
import { ideas as GLOBAL_IDEAS, anglesByIdea } from "./mocks.js?v=92";
