...
import { postAssistantChoice, startPending, finishPending, postDraftResult } from "./assistant.js?v=84";
import { getIdeas } from "./library.js?v=78";
import { ideas as GLOBAL_IDEAS, anglesByIdea } from "./mocks.js?v=81";
