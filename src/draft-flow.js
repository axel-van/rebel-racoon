...
import { postAssistantChoice, startPending, finishPending, postDraftResult } from "./assistant.js?v=94";
import { getIdeas } from "./library.js?v=88";
import { ideas as GLOBAL_IDEAS, anglesByIdea } from "./mocks.js?v=90";
