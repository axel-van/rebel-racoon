...
import { postAssistantChoice, startPending, finishPending, postDraftResult } from "./assistant.js?v=69";
import { getIdeas } from "./library.js?v=63";
import { ideas as GLOBAL_IDEAS, anglesByIdea } from "./mocks.js?v=68";
