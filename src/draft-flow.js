...
import { postAssistantChoice, startPending, finishPending, postDraftResult } from "./assistant.js?v=64";
import { getIdeas } from "./library.js?v=58";
import { ideas as GLOBAL_IDEAS, anglesByIdea } from "./mocks.js?v=61";
