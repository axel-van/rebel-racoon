...
import { postAssistantChoice, startPending, finishPending, postDraftResult } from "./assistant.js?v=80";
import { getIdeas } from "./library.js?v=74";
import { ideas as GLOBAL_IDEAS, anglesByIdea } from "./mocks.js?v=77";
