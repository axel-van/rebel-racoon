...
import { postAssistantChoice, startPending, finishPending, postDraftResult } from "./assistant.js?v=101";
import { getIdeas } from "./library.js?v=95";
import { ideas as GLOBAL_IDEAS, anglesByIdea } from "./mocks.js?v=93";
