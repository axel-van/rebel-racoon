...
import { postAssistantChoice, startPending, finishPending, postDraftResult } from "./assistant.js?v=81";
import { getIdeas } from "./library.js?v=75";
import { ideas as GLOBAL_IDEAS, anglesByIdea } from "./mocks.js?v=78";
