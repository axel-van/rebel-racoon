...
import { postAssistantChoice, startPending, finishPending, postDraftResult } from "./assistant.js?v=93";
import { getIdeas } from "./library.js?v=87";
import { ideas as GLOBAL_IDEAS, anglesByIdea } from "./mocks.js?v=89";
