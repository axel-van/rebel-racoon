...
import { postAssistantChoice, startPending, finishPending, postDraftResult } from "./assistant.js?v=59";
import { getIdeas } from "./library.js?v=49";
import { ideas as GLOBAL_IDEAS, anglesByIdea } from "./mocks.js?v=57";
