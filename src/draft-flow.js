...
import { postAssistantChoice, startPending, finishPending, postDraftResult } from "./assistant.js?v=88";
import { getIdeas } from "./library.js?v=82";
import { ideas as GLOBAL_IDEAS, anglesByIdea } from "./mocks.js?v=84";
