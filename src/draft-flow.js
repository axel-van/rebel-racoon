...
import { postAssistantChoice, startPending, finishPending, postDraftResult } from "./assistant.js?v=63";
import { getIdeas } from "./library.js?v=57";
import { ideas as GLOBAL_IDEAS, anglesByIdea } from "./mocks.js?v=60";
