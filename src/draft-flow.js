...
import { postAssistantChoice, startPending, finishPending, postDraftResult } from "./assistant.js?v=40";
import { getIdeas } from "./library.js?v=32";
import { ideas as GLOBAL_IDEAS, anglesByIdea } from "./mocks.js?v=39";
