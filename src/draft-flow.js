...
import { postAssistantChoice, startPending, finishPending, postDraftResult } from "./assistant.js?v=89";
import { getIdeas } from "./library.js?v=83";
import { ideas as GLOBAL_IDEAS, anglesByIdea } from "./mocks.js?v=85";
