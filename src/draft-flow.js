...
import { postAssistantChoice, startPending, finishPending, postDraftResult } from "./assistant.js?v=97";
import { getIdeas } from "./library.js?v=91";
import { ideas as GLOBAL_IDEAS, anglesByIdea } from "./mocks.js?v=91";
