...
import { postAssistantChoice, startPending, finishPending, postDraftResult } from "./assistant.js?v=67";
import { getIdeas } from "./library.js?v=61";
import { ideas as GLOBAL_IDEAS, anglesByIdea } from "./mocks.js?v=66";
