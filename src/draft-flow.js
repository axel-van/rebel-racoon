...
import { postAssistantChoice, startPending, finishPending, postDraftResult } from "./assistant.js?v=43";
import { getIdeas } from "./library.js?v=33";
import { ideas as GLOBAL_IDEAS, anglesByIdea } from "./mocks.js?v=44";
