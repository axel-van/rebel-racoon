...
import { postAssistantChoice, startPending, finishPending, postDraftResult } from "./assistant.js?v=77";
import { getIdeas } from "./library.js?v=71";
import { ideas as GLOBAL_IDEAS, anglesByIdea } from "./mocks.js?v=74";
