...
import { postAssistantChoice, startPending, finishPending, postDraftResult } from "./assistant.js?v=91";
import { getIdeas } from "./library.js?v=85";
import { ideas as GLOBAL_IDEAS, anglesByIdea } from "./mocks.js?v=87";
