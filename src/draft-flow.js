...
import { postAssistantChoice, startPending, finishPending, postDraftResult } from "./assistant.js?v=73";
import { getIdeas } from "./library.js?v=67";
import { ideas as GLOBAL_IDEAS, anglesByIdea } from "./mocks.js?v=70";
