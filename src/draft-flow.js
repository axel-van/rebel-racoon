...
import { postAssistantChoice, startPending, finishPending, postDraftResult } from "./assistant.js?v=92";
import { getIdeas } from "./library.js?v=86";
import { ideas as GLOBAL_IDEAS, anglesByIdea } from "./mocks.js?v=88";
