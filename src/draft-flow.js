...
import { postAssistantChoice, startPending, finishPending, postDraftResult } from "./assistant.js?v=82";
import { getIdeas } from "./library.js?v=76";
import { ideas as GLOBAL_IDEAS, anglesByIdea } from "./mocks.js?v=79";
