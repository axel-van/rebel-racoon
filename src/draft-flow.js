...
import { postAssistantChoice, startPending, finishPending, postDraftResult } from "./assistant.js?v=76";
import { getIdeas } from "./library.js?v=70";
import { ideas as GLOBAL_IDEAS, anglesByIdea } from "./mocks.js?v=73";
