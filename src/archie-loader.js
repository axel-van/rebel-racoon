...
// same "pixel-pop" mark: an orange Archie glyph revealed through a wave
// of rounded squares that pop in (scale overshoot) along a path.
//
...
// The provided 02b-pixel-pop loader, recoloured to `currentColor` and
// with the mask id templated (`__MASKID__`) so each injected copy gets a
// document-unique id — duplicate ids would make every instance reference
// the first loader's mask and break when it unmounts.
const LOADER_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 227.15 170.03" preserveAspectRatio="xMidYMid meet" focusable="false" aria-hidden="true"><defs><mask id="__MASKID__"><g transform="translate(99,24)"><rect x="-30.0" y="-30.0" width="60" height="60" rx="10" fill="#fff" transform="scale(0)"><animateTransform attributeName="transform" type="scale" values="0;0;1.08;1;0;0" keyTimes="0;0.06;0.32;0.50;0.86;1" calcMode="spline" keySplines="0 0 1 1;0.34 0.7 0.5 1;0.5 0 0.5 1;0.42 0 0.58 1;0 0 1 1" dur="0.8s" begin="0.000s" repeatCount="indefinite"/></rect></g><g transform="translate(56,64)"><rect x="-30.0" y="-30.0" width="60" height="60" rx="10" fill="#fff" transform="scale(0)"><animateTransform attributeName="transform" type="scale" values="0;0;1.08;1;0;0" keyTimes="0;0.06;0.32;0.50;0.86;1" calcMode="spline" keySplines="0 0 1 1;0.34 0.7 0.5 1;0.5 0 0.5 1;0.42 0 0.58 1;0 0 1 1" dur="0.8s" begin="0.114s" repeatCount="indefinite"/></rect></g><g transform="translate(20,99)"><rect x="-30.0" y="-30.0" width="60" height="60" rx="10" fill="#fff" transform="scale(0)"><animateTransform attributeName="transform" type="scale" values="0;0;1.08;1;0;0" keyTimes="0;0.06;0.32;0.50;0.86;1" calcMode="spline" keySplines="0 0 1 1;0.34 0.7 0.5 1;0.5 0 0.5 1;0.42 0 0.58 1;0 0 1 1" dur="0.8s" begin="0.229s" repeatCount="indefinite"/></rect></g><g transform="translate(66,144)"><rect x="-30.0" y="-30.0" width="60" height="60" rx="10" fill="#fff" transform="scale(0)"><animateTransform attributeName="transform" type="scale" values="0;0;1.08;1;0;0" keyTimes="0;0.06;0.32;0.50;0.86;1" calcMode="spline" keySplines="0 0 1 1;0.34 0.7 0.5 1;0.5 0 0.5 1;0.42 0 0.58 1;0 0 1 1" dur="0.8s" begin="0.343s" repeatCount="indefinite"/></rect></g><g transform="translate(113,97)"><rect x="-30.0" y="-30.0" width="60" height="60" rx="10" fill="#fff" transform="scale(0)"><animateTransform attributeName="transform" type="scale" values="0;0;1.08;1;0;0" keyTimes="0;0.06;0.32;0.50;0.86;1" calcMode="spline" keySplines="0 0 1 1;0.34 0.7 0.5 1;0.5 0 0.5 1;0.42 0 0.58 1;0 0 1 1" dur="0.8s" begin="0.457s" repeatCount="indefinite"/></rect></g><g transform="translate(158,53)"><rect x="-30.0" y="-30.0" width="60" height="60" rx="10" fill="#fff" transform="scale(0)"><animateTransform attributeName="transform" type="scale" values="0;0;1.08;1;0;0" keyTimes="0;0.06;0.32;0.50;0.86;1" calcMode="spline" keySplines="0 0 1 1;0.34 0.7 0.5 1;0.5 0 0.5 1;0.42 0 0.58 1;0 0 1 1" dur="0.8s" begin="0.571s" repeatCount="indefinite"/></rect></g><g transform="translate(204,97)"><rect x="-30.0" y="-30.0" width="60" height="60" rx="10" fill="#fff" transform="scale(0)"><animateTransform attributeName="transform" type="scale" values="0;0;1.08;1;0;0" keyTimes="0;0.06;0.32;0.50;0.86;1" calcMode="spline" keySplines="0 0 1 1;0.34 0.7 0.5 1;0.5 0 0.5 1;0.42 0 0.58 1;0 0 1 1" dur="0.8s" begin="0.686s" repeatCount="indefinite"/></rect></g></mask></defs><path d="M227.15,81.98v29.37c0,4.69-3.81,8.5-8.5,8.5h-29.37c-4.69,0-8.5-3.81-8.5-8.5v-27.11c0-4.69-3.78-8.5-8.47-8.5h-27.45c-4.69,0-8.5,3.81-8.5,8.5v26.91c0,4.69-3.78,8.47-8.47,8.47h-28.92c-4.69,0-8.5,3.81-8.5,8.5v33.89c0,4.69-3.78,8.47-8.47,8.47h-32.67c-4.69,0-8.47-3.78-8.47-8.47v-34.03c0-4.69-3.81-8.47-8.5-8.47H8.47c-4.69,0-8.47-3.81-8.47-8.5v-23.86c0-4.69,3.78-8.47,8.47-8.47h23.89c4.69,0,8.5-3.81,8.5-8.5v-14.18c0-4.69,3.78-8.5,8.47-8.5h16.07c4.69,0,8.47-3.78,8.47-8.44V8.5C73.87,3.81,77.66,0,82.34,0h32.64C119.67,0,123.46,3.81,123.46,8.5v32.11c0,4.69-3.78,8.47-8.47,8.47h-32.64c-4.69,0-8.47,3.81-8.47,8.5v14.46c0,4.69-3.81,8.5-8.5,8.5h-16.04c-4.69,0-8.47,3.78-8.47,8.47v20.05c0,4.69,3.78,8.5,8.47,8.5h32.67c4.69,0,8.47-3.81,8.47-8.5v-26.83c0-4.72,3.81-8.5,8.5-8.5h30.38c3.87,0,7-3.13,7-7v-26.94c0-4.69,3.81-8.5,8.5-8.5h27.45c4.69,0,8.47,3.81,8.47,8.5v25.22c0,4.69,3.81,8.47,8.5,8.47h29.37c4.69,0,8.5,3.81,8.5,8.5Z" fill="currentColor" mask="url(#__MASKID__)"/></svg>`;
