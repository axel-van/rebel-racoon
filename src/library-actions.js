...
import { appendExtractedIdeas, removeIdeasForSources, removeIdeas, getIdeas } from "./library.js?v=45";
import { removeSources as streamRemoveSources, getSources as streamGetSources } from "./sources-stream.js?v=47";
