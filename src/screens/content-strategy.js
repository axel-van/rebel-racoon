...
import { getActivePlaybook, getActivePlaybookId, subscribe as subscribeScope } from "../active-playbook.js?v=21";
import { open as openConfirm } from "../components/confirm-modal.js?v=22";
import { open as openPillarModal } from "../components/pillar-modal.js?v=20";
import {
  getPillars,
  getPillarById,
  deletePillar,
