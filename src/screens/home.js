import { html, raw, escapeText, escapeAttr } from "../utils.js?v=1229";
...
import {
  ...
  duplicateContext,
  deleteContext,
} from "../contexts-store.js?v=1229";
import { getSessions, getSessionById, subscribe as subscribeSessions } from "../sessions-store.js?v=1229";
import { getSources, getIdeas } from "../library.js?v=1229";
import { getPosts } from "../posts-store.js?v=1229";
import { parseHashParams, setHashQuery } from "../url-state.js?v=1229";
import { closePanel as closeRightPanel } from "../components/right-panel.js?v=1229";
import { navigate, getPath } from "../router.js?v=1229";
import { setHandoff } from "../handoff.js?v=1229";
import { open as openConfirmModal } from "../components/confirm-modal.js?v=1229";
import { renderEmptyState } from "../components/empty-state.js?v=1229";
import {
  visibleContexts,
  usableContexts,
  canView,
  ...
  accessLabel,
  isMine,
} from "../playbook-access.js?v=1229";
import { isWorkspaceMode, getActivePlaybookId, setActivePlaybook, catalogueRoute } from "../active-playbook.js?v=1229";
import { open as openShareModal } from "../components/share-playbook-modal.js?v=1229";
import { installMoreMenu } from "../components/more-menu.js?v=1229";
import { renderStarterCards } from "../components/starter-card.js?v=1229";
import { isFlagOn } from "../feature-flags.js?v=1229";
import { getConnectedConnectors } from "../connectors-store.js?v=1229";
import { renderConnectorLogo } from "../connectors-view.js?v=1229";
import { ownerOf } from "../playbook-access.js?v=1229";
...
function bind(root) {
  root.addEventListener("click", (event) => {
    ...
    if (dupBtn) {
      ...
      if (copy) {
        import("../components/toast.js?v=1229").then(({ showToast }) => showToast("Playbook duplicated"));
    ...
    if (delBtn) {
      ...
      if (getContexts().length <= 1) {
        import("../components/toast.js?v=1229").then(({ showToast }) =>
      ...
      openConfirmModal({
        ...
        onConfirm: () => {
          ...
          import("../components/toast.js?v=1229").then(({ showToast }) => showToast("Playbook deleted"));
        },
      });
      return;
    }
