...
import {
  ...
  duplicateContext,
  deleteContext,
} from "../contexts-store.js?v=1211";
import { getSessions, getSessionById, subscribe as subscribeSessions } from "../sessions-store.js?v=1211";
import { getSources, getIdeas } from "../library.js?v=1211";
import { getPosts } from "../posts-store.js?v=1211";
import { parseHashParams, setHashQuery } from "../url-state.js?v=1211";
import { closePanel as closeRightPanel } from "../components/right-panel.js?v=1211";
import { navigate, getPath } from "../router.js?v=1211";
import { setHandoff } from "../handoff.js?v=1211";
import { open as openConfirmModal } from "../components/confirm-modal.js?v=1211";
...
import {
  ...
  accessLabel,
  isMine,
} from "../playbook-access.js?v=1211";
import { isWorkspaceMode, getActivePlaybookId, setActivePlaybook, catalogueRoute } from "../active-playbook.js?v=1211";
import { open as openShareModal } from "../components/share-playbook-modal.js?v=1211";
import { installMoreMenu } from "../components/more-menu.js?v=1211";
...
import { ownerOf } from "../playbook-access.js?v=1211";
...
function bind(root) {
  root.addEventListener("click", (event) => {
    ...
    if (dupBtn) {
      ...
      if (copy) {
        import("../components/toast.js?v=1211").then(({ showToast }) => showToast("Playbook duplicated"));
    ...
    if (delBtn) {
      ...
      if (getContexts().length <= 1) {
        import("../components/toast.js?v=1211").then(({ showToast }) =>
      ...
      openConfirmModal({
        ...
        onConfirm: () => {
          ...
          import("../components/toast.js?v=1211").then(({ showToast }) => showToast("Playbook deleted"));
        },
      });
      return;
    }
