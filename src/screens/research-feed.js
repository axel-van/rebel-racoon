...
import { renderTopbar, setTopbarActions, clearTopbarActions } from "../components/topbar.js?v=437";
import { isFlagOn } from "../feature-flags.js?v=22";
import { renderBriefCard, renderUseButtons } from "../components/brief-card.js?v=56";
import {
  openIgnoreReason,
  openVersionHistory,
  openSourcePosts,
...
} from "../components/research-modals.js?v=123";
...
import { getActivePlaybookId, subscribe as subscribeScope } from "../active-playbook.js?v=25";
import { open as openPillarPicker } from "../components/pillar-picker-modal.js?v=16";
