...
import { renderTopbar, setTopbarActions, clearTopbarActions } from "../components/topbar.js?v=486";
...
} from "../components/research-modals.js?v=173";
...
import { open as openPillarPicker } from "../components/pillar-picker-modal.js?v=65";
