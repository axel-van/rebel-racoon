...
import { renderTopbar, setTopbarActions, clearTopbarActions } from "../components/topbar.js?v=450";
import { isFlagOn } from "../feature-flags.js?v=23";
import { renderBriefCard, renderUseButtons } from "../components/brief-card.js?v=65";
import {
  openIgnoreReason,
  openVersionHistory,
  openSourcePosts,
...
} from "../components/research-modals.js?v=137";
...
import { getActivePlaybookId, subscribe as subscribeScope } from "../active-playbook.js?v=41";
import { open as openPillarPicker } from "../components/pillar-picker-modal.js?v=29";
