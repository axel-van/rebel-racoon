...
import { renderTopbar, setTopbarActions, clearTopbarActions } from "../components/topbar.js?v=451";
import { isFlagOn } from "../feature-flags.js?v=23";
import { renderBriefCard, renderUseButtons } from "../components/brief-card.js?v=66";
import {
  openIgnoreReason,
  openVersionHistory,
  openSourcePosts,
...
} from "../components/research-modals.js?v=138";
...
import { getActivePlaybookId, subscribe as subscribeScope } from "../active-playbook.js?v=42";
import { open as openPillarPicker } from "../components/pillar-picker-modal.js?v=30";
