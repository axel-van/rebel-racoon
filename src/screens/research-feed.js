...
import { renderTopbar, setTopbarActions, clearTopbarActions } from "../components/topbar.js?v=491";
...
} from "../components/research-modals.js?v=178";
...
import { open as openPillarPicker } from "../components/pillar-picker-modal.js?v=70";
