...
import { renderTopbar, setTopbarActions, clearTopbarActions } from "../components/topbar.js?v=455";
...
} from "../components/research-modals.js?v=142";
...
import { getActivePlaybookId, subscribe as subscribeScope } from "../active-playbook.js?v=46";
import { open as openPillarPicker } from "../components/pillar-picker-modal.js?v=34";
