...
import { renderTopbar, setTopbarActions, clearTopbarActions } from "../components/topbar.js?v=438";
...
} from "../components/research-modals.js?v=124";
...
import { getActivePlaybookId, subscribe as subscribeScope } from "../active-playbook.js?v=26";
import { open as openPillarPicker } from "../components/pillar-picker-modal.js?v=17";
