...
import { renderTopbar, setTopbarActions, clearTopbarActions } from "../components/topbar.js?v=449";
...
} from "../components/research-modals.js?v=136";
...
import { getActivePlaybookId, subscribe as subscribeScope } from "../active-playbook.js?v=40";
import { open as openPillarPicker } from "../components/pillar-picker-modal.js?v=28";
