...
import { adoptAndDraft } from "../research-flow.js?v=4";
import { getFinding } from "../research-store.js?v=3";
...
import * as contextBuilder from "../context-builder.js?v=193";
...
} from "../components/right-panel.js?v=360";
