...
import { renderTopbar } from "../components/topbar.js?v=150";
...
import * as contextBuilder from "../context-builder.js?v=132";
...
import { open as openGenerateImageModal } from "../components/generate-image-modal.js?v=29";
