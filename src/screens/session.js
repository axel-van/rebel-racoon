...
import { getBriefById, getStarterTopics } from "../briefs-store.js?v=44";
import { BRIEF_CHAT_HANDOFF, attachBriefToChat, openBriefInChat } from "../brief-flow.js?v=17";
import { PILLAR_CHAT_HANDOFF, attachPillarToChat } from "../pillar-flow.js?v=9";
import { getLaneById } from "../research-store.js?v=37";
import * as contextBuilder from "../context-builder.js?v=350";
...
import { openIdeaPicker, openPillarPicker } from "../components/research-modals.js?v=91";
...
} from "../components/right-panel.js?v=517";
