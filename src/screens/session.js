import { html, raw, escapeHtml, escapeAttr as escapeHtmlAttr } from "../utils.js?v=1155";
import { navigate } from "../router.js?v=1155";
import { renderTopbar } from "../components/topbar.js?v=1155";
import { socialAccounts, connectorDocs } from "../mocks.js?v=1155";
import {
...
import { formatsForNetwork, defaultFormatFor } from "../clip-formats.js?v=1155";
import { getSessionById, getSessions } from "../sessions-store.js?v=1155";
import { getContextById, getContexts, updateContext } from "../contexts-store.js?v=1155";
import { playbookForNewWork, isWorkspaceMode, catalogueRoute } from "../active-playbook.js?v=1155";
import { revokedContextFor, usableContexts, canView } from "../playbook-access.js?v=1155";
import { isNewUser } from "../user-mode.js?v=1155";
import {
  getThread,
  sendMessage,
  ...
  answerTopicsWidget,
} from "../assistant.js?v=1155";
import { iconFor as fileIconForKind } from "../file-kinds.js?v=1155";
import { getSources, getIdeas, extractVideoIdeas, appendExtractedIdeas } from "../library.js?v=1155";
import { wireLibraryActions, renderSourcesBulkBar, renderIdeasBulkBar } from "../library-actions.js?v=1155";
import {
...
} from "../composer-mentions.js?v=1155";
import { addPostDraft, setSubtitleStyle } from "../posts-store.js?v=1155";
import { startDraftFlow, executeDraft, executeDraftBatch, getAnglesForIdea } from "../draft-flow.js?v=1155";
import * as topPostsFlow from "../top-posts-flow.js?v=1155";
import {
  renderTopPostsBoard,
  renderTopPostEcho,
  renderTopPostsWidget,
  TOP_POSTS_LIMIT,
} from "../components/top-post-card.js?v=1155";
import { getTopPost } from "../top-posts-store.js?v=1155";
import { renderEmptyState } from "../components/empty-state.js?v=1155";
import { renderStarterCards } from "../components/starter-card.js?v=1155";
import * as sidebarWizard from "../sidebar-wizard.js?v=1155";
import * as inlineQuestion from "../inline-question.js?v=1155";
import {
  requireConnectedProfiles,
  connectableNetworkCards,
  accountIdsForNetwork,
} from "../connect-profiles-flow.js?v=1155";
import { open as openConnectAccountModal } from "../components/connect-account-modal.js?v=1155";
import * as clipStudio from "../clip-studio.js?v=1155";
import * as batchStudio from "../batch-studio.js?v=1155";
import { askConnector } from "../connector-ask.js?v=1155";
import { getConnectedConnectors, findConnector, setConnectorStatus } from "../connectors-store.js?v=1155";
import { renderConnectorLogo } from "../connectors-view.js?v=1155";
import {
  getActiveConnector,
  clearActiveConnector,
  subscribe as subscribeComposerConnector,
} from "../composer-connector.js?v=1155";
import { isFlagOn } from "../feature-flags.js?v=1155";
import * as contextBuilder from "../context-builder.js?v=1155";
import { renderPicker } from "./_analyse-common.js?v=1155";
import { renderSourceCard } from "../components/source-card.js?v=1155";
import { renderCompactIdeaCard } from "../components/idea-card-compact.js?v=1155";
import { contentState, rerenderContentWorkspaceBody } from "../components/content-workspace.js?v=1155";
import { open as openVideoClipsModal } from "../components/video-clips-modal.js?v=1155";
import { open as openChatPickerModal } from "../components/chat-picker-modal.js?v=1155";
import { open as openAddSourceModal } from "../components/add-source-modal.js?v=1155";
import { open as openConnectorsModal } from "../components/connectors-modal.js?v=1155";
import { dropzoneHTML } from "../components/dropzone.js?v=1155";
import {
  classifyFile,
  startFileUpload,
  startUrlImport,
  ...
  setSourceIdeaCount,
} from "../sources-stream.js?v=1155";
import { renderClipCard } from "../components/clip-card.js?v=1155";
import { onFeedbackClick } from "../components/feedback-control.js?v=1155";
import { showToast } from "../components/toast.js?v=1155";
import {
...
} from "../components/right-panel.js?v=1155";
import { setHandoff, consumeHandoff } from "../handoff.js?v=1155";
import { attachTopicToChat, useTopicInChat, startTopicPickerInline, TOPIC_CHAT_HANDOFF } from "../topic-flow.js?v=1155";
import { startObjectiveChat, OBJECTIVE_CHAT_HANDOFF } from "../objective-flow.js?v=1155";
import { getFeedForPlaybook } from "../topic-feeds-store.js?v=1155";
import {
  getFreshTopics,
  countFresh,
  getTopicById,
...
} from "../topics-store.js?v=1155";
import { findTopicSource } from "../topics-catalog.js?v=1155";
import { renderTopicCard, renderTopicsWidget } from "../components/topic-card.js?v=1155";
import { openTopicArticle } from "../components/topic-picker-modal.js?v=1155";
import { parseHashParams, setHashQuery } from "../url-state.js?v=1155";
import { updateLoadingWatchdog, stopThinkingTimer } from "./session/thinking-chip.js?v=1155";
import { startIntakeLifecycle } from "./session/intake-lifecycle.js?v=1155";
import { rebindWizardKeyboard } from "./session/wizard-keyboard.js?v=1155";
import { clipContext } from "./session/clip-draft-flow.js?v=1155";
...
import {
  ...
  renderResultCard,
} from "./session/thread-turns.js?v=1155";
