...
import { renderTopbar } from "../components/topbar.js?v=94";
...
import * as contextBuilder from "../context-builder.js?v=78";
import * as playbookEditor from "../playbook-editor.js?v=39";
