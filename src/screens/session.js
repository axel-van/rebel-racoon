...
import { getActivePlaybook, getActivePlaybookId } from "../active-playbook.js?v=19";
...
import * as contextBuilder from "../context-builder.js?v=399";
...
} from "../components/right-panel.js?v=566";
