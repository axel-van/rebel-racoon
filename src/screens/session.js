...
import { renderTopbar } from "../components/topbar.js?v=151";
...
import * as contextBuilder from "../context-builder.js?v=133";
...
import { open as openGenerateImageModal } from "../components/generate-image-modal.js?v=30";
