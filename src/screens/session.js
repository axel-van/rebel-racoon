...
import { renderTopbar } from "../components/topbar.js?v=152";
...
import * as contextBuilder from "../context-builder.js?v=134";
...
import { open as openGenerateImageModal } from "../components/generate-image-modal.js?v=31";
