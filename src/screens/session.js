...
import { getActivePlaybook, getActivePlaybookId } from "../active-playbook.js?v=47";
...
import { open as openPillarModal } from "../components/pillar-modal.js?v=43";
import { getLaneById, getLanes } from "../research-store.js?v=49";
import * as contextBuilder from "../context-builder.js?v=423";
...
import { openIdeaArticle, openIdeaPicker, openPillarPicker } from "../components/research-modals.js?v=143";
...
} from "../components/right-panel.js?v=590";
