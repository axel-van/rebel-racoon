...
import { BRIEF_CHAT_HANDOFF, attachBriefToChat, openBriefInChat } from "../brief-flow.js?v=41";
...
import * as contextBuilder from "../context-builder.js?v=439";
...
import { openIdeaArticle, openIdeaPicker, openPillarPicker } from "../components/research-modals.js?v=159";
...
} from "../components/right-panel.js?v=606";
