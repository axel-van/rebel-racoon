...
import { getActivePlaybook, getActivePlaybookId } from "../active-playbook.js?v=18";
...
import * as contextBuilder from "../context-builder.js?v=398";
...
} from "../components/right-panel.js?v=565";
