...
import { renderTopbar } from "../components/topbar.js?v=370";
import { socialAccounts, chatStarters, connectorDocs } from "../mocks.js?v=87";
import {
...
} from "../social-profiles.js?v=58";
import { FORMATS, formatsForNetwork, defaultFormatFor, clipFormatItems } from "../clip-formats.js?v=38";
import { CLIP_SUBTITLE_ITEMS, CLIP_SUBTITLE_LABEL } from "../clip-subtitles.js?v=1";
import { getSessionById, getSessions, subscribe as subscribeSessions } from "../sessions-store.js?v=35";
import { getContextById, getContexts, getDefaultContext, updateContext } from "../contexts-store.js?v=69";
...
} from "../assistant.js?v=91";
import { iconFor as fileIconForKind } from "../file-kinds.js?v=20";
import { getSources, getIdeas, extractVideoIdeas } from "../library.js?v=85";
import { wireLibraryActions, renderSourcesBulkBar, renderIdeasBulkBar } from "../library-actions.js?v=74";
import {
...
} from "../composer-mentions.js?v=59";
import { getPosts, addPostDraft, setSubtitleStyle, subscribe as subscribePostsStore } from "../posts-store.js?v=64";
import { startDraftFlow, executeDraft, executeDraftBatch, getAnglesForIdea } from "../draft-flow.js?v=89";
import { startActionPickerFlow, handleActionPick } from "../start-flow.js?v=71";
import * as topPostsFlow from "../top-posts-flow.js?v=111";
import {
  renderTopPostsBoard,
  renderTopPostEcho,
  renderTopPostsWidget,
  TOP_POSTS_LIMIT,
} from "../components/top-post-card.js?v=116";
import { getTopPost } from "../top-posts-store.js?v=77";
import { renderEmptyState } from "../components/empty-state.js?v=1";
import * as sidebarWizard from "../sidebar-wizard.js?v=81";
import * as inlineQuestion from "../inline-question.js?v=48";
import * as clipStudio from "../clip-studio.js?v=55";
import * as batchStudio from "../batch-studio.js?v=4";
import { askConnector } from "../connector-ask.js?v=36";
import { getConnectedConnectors, findConnector, setConnectorStatus } from "../connectors-store.js?v=56";
import { renderConnectorLogo } from "../connectors-view.js?v=38";
import {
  getActiveConnector,
...
import { getBriefById, getStarterTopics } from "../briefs-store.js?v=41";
import { BRIEF_CHAT_HANDOFF, attachBriefToChat, openBriefInChat } from "../brief-flow.js?v=14";
import { PILLAR_CHAT_HANDOFF, attachPillarToChat } from "../pillar-flow.js?v=8";
import { getLaneById } from "../research-store.js?v=34";
import * as contextBuilder from "../context-builder.js?v=337";
...
import { open as openVideoClipsModal } from "../components/video-clips-modal.js?v=86";
import { open as openChatPickerModal } from "../components/chat-picker-modal.js?v=93";
import { open as openAddSourceModal } from "../components/add-source-modal.js?v=94";
import { open as openConnectorsModal } from "../components/connectors-modal.js?v=40";
...
import {
  ...
  setSourceIdeaCount,
  addReadySource,
} from "../sources-stream.js?v=83";
import { renderClipCard } from "../components/clip-card.js?v=47";
...
import { openIdeaPicker, openPillarPicker } from "../components/research-modals.js?v=78";
...
} from "../components/right-panel.js?v=504";
import { setHandoff, consumeHandoff, hasHandoff } from "../handoff.js?v=20";
import { startTopicChat, TOPIC_CHAT_HANDOFF } from "../topic-flow.js?v=30";
import { parseHashParams, setHashQuery } from "../url-state.js?v=21";
import { updateLoadingWatchdog, stopThinkingTimer } from "./session/thinking-chip.js?v=49";
import { startIntakeLifecycle } from "./session/intake-lifecycle.js?v=57";
import { rebindWizardKeyboard } from "./session/wizard-keyboard.js?v=72";
...
function renderStarterTopicCard(brief) {
  ...
  // Object]" here.
  // Playbook › topic list, wrapped in ONE element so the three parts share a
  // tight gap of their own. It is now the ONLY thing on the head row — the
  // signal mark moved down to the end of the title — so the crumb gets the whole
  // width and the topic list ellipsises inside it rather than the crumb being
  // clipped as a block.
