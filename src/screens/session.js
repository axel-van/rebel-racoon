...
import { getActivePlaybook, getActivePlaybookId } from "../active-playbook.js?v=16";
...
import * as contextBuilder from "../context-builder.js?v=396";
...
import { openIdeaArticle, openIdeaPicker, openPillarPicker } from "../components/research-modals.js?v=117";
...
} from "../components/right-panel.js?v=563";
