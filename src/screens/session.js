...
import { getActivePlaybook, getActivePlaybookId } from "../active-playbook.js?v=11";
...
import * as contextBuilder from "../context-builder.js?v=391";
...
} from "../components/right-panel.js?v=558";
