...
import { renderTopbar } from "../components/topbar.js?v=68";
...
import * as contextBuilder from "../context-builder.js?v=52";
import * as playbookEditor from "../playbook-editor.js?v=13";
