...
import { catalogueRoute } from "../active-playbook.js?v=1150";
import { getDraft, isAnalysisReady, save, patchDraft, restoreDraft } from "../context-builder.js?v=1150";
import { mount } from "../playbook-view.js?v=1150";
