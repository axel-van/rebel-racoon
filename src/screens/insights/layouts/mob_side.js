...
import { playbookTitle, objectiveTitle, objectiveActions, esc } from "../pieces.js?v=1167";
import { mountCharts } from "../charts.js?v=1167";
import { readLede, readNotice, readMeasures, readPosts, readFacts } from "../read.js?v=1167";
