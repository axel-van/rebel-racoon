...
import { getContextById, getContexts, updateContext, deleteContext } from "../contexts-store.js?v=39";
import { mount, snapshotEditable } from "../playbook-view.js?v=52";
...
import { open as openAnalyzeProfilesModal } from "../components/analyze-profiles-modal.js?v=15";
...
import { sectionPatchFromAnalysis } from "../context-builder.js?v=189";
