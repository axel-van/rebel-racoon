...
import { getContextById, getContexts, updateContext, deleteContext } from "../contexts-store.js?v=79";
import { mount, snapshotEditable } from "../playbook-view.js?v=102";
...
import { open as openAnalyzeProfilesModal } from "../components/analyze-profiles-modal.js?v=54";
...
import { sectionPatchFromAnalysis } from "../context-builder.js?v=418";
