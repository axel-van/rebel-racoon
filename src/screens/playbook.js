...
import { escapeHtml as esc } from "../utils.js?v=1212";
...
import { isWorkspaceMode, setActivePlaybook, catalogueRoute } from "../active-playbook.js?v=1212";
import { mount, snapshotEditable } from "../playbook-view.js?v=1212";
import { open as openRenameModal } from "../components/rename-modal.js?v=1212";
import { open as openConfirmModal } from "../components/confirm-modal.js?v=1212";
import { open as openAnalyzeProfilesModal } from "../components/analyze-profiles-modal.js?v=1212";
import { open as openFillDocumentModal } from "../components/fill-document-modal.js?v=1212";
import { analyzeWebsite, analyzeDocument, analyzeSocialProfiles } from "../context-mock-analysis.js?v=1212";
import { sectionPatchFromAnalysis } from "../context-builder.js?v=1212";
import {
  canView,
  canEdit,
  canGovern,
...
function toast(msg) {
  import("../components/toast.js?v=1212").then(({ showToast }) => showToast(msg));
}
