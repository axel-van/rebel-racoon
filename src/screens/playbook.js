...
import { mount, snapshotEditable } from "../playbook-view.js?v=30";
...
import { open as openAnalyzeProfilesModal } from "../components/analyze-profiles-modal.js?v=10";
...
import { sectionPatchFromAnalysis } from "../context-builder.js?v=147";
