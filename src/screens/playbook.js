...
import { getContextById, getContexts, updateContext, deleteContext } from "../contexts-store.js?v=52";
import { mount, snapshotEditable } from "../playbook-view.js?v=69";
...
import { open as openAnalyzeProfilesModal } from "../components/analyze-profiles-modal.js?v=29";
...
import { sectionPatchFromAnalysis } from "../context-builder.js?v=267";
