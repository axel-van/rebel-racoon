...
import { getContextById, getContexts, updateContext, deleteContext } from "../contexts-store.js?v=54";
import { mount, snapshotEditable } from "../playbook-view.js?v=71";
...
import { open as openAnalyzeProfilesModal } from "../components/analyze-profiles-modal.js?v=31";
...
import { sectionPatchFromAnalysis } from "../context-builder.js?v=269";
