...
import { getContextById, getContexts, updateContext, deleteContext } from "../contexts-store.js?v=65";
import { mount, snapshotEditable } from "../playbook-view.js?v=87";
...
import { open as openAnalyzeProfilesModal } from "../components/analyze-profiles-modal.js?v=41";
...
import { sectionPatchFromAnalysis } from "../context-builder.js?v=329";
