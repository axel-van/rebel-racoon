...
import { getContextById, getContexts, updateContext, deleteContext } from "../contexts-store.js?v=67";
import { mount, snapshotEditable } from "../playbook-view.js?v=89";
...
import { open as openAnalyzeProfilesModal } from "../components/analyze-profiles-modal.js?v=43";
...
import { sectionPatchFromAnalysis } from "../context-builder.js?v=335";
