...
import { getContextById, getContexts, updateContext, deleteContext } from "../contexts-store.js?v=73";
import { mount, snapshotEditable } from "../playbook-view.js?v=95";
...
import { open as openAnalyzeProfilesModal } from "../components/analyze-profiles-modal.js?v=49";
...
import { sectionPatchFromAnalysis } from "../context-builder.js?v=367";
