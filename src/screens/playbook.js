...
import { getContextById, getContexts, updateContext, deleteContext } from "../contexts-store.js?v=35";
import { mount, snapshotEditable } from "../playbook-view.js?v=37";
...
import { open as openAnalyzeProfilesModal } from "../components/analyze-profiles-modal.js?v=13";
...
import { sectionPatchFromAnalysis } from "../context-builder.js?v=165";
