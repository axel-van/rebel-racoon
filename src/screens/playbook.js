...
import { getContextById, getContexts, updateContext, deleteContext } from "../contexts-store.js?v=82";
import { mount, snapshotEditable } from "../playbook-view.js?v=105";
...
import { open as openAnalyzeProfilesModal } from "../components/analyze-profiles-modal.js?v=57";
...
import { sectionPatchFromAnalysis } from "../context-builder.js?v=444";
