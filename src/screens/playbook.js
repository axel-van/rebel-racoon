...
import { mount, snapshotEditable } from "../playbook-view.js?v=55";
...
import { open as openAnalyzeProfilesModal } from "../components/analyze-profiles-modal.js?v=18";
...
import { sectionPatchFromAnalysis } from "../context-builder.js?v=209";
