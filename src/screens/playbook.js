...
import { getContextById, getContexts, updateContext, deleteContext } from "../contexts-store.js?v=70";
import { mount, snapshotEditable } from "../playbook-view.js?v=92";
...
import { open as openAnalyzeProfilesModal } from "../components/analyze-profiles-modal.js?v=46";
...
import { sectionPatchFromAnalysis } from "../context-builder.js?v=341";
