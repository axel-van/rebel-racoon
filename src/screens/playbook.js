...
import { getContextById, getContexts, updateContext, deleteContext } from "../contexts-store.js?v=74";
import { mount, snapshotEditable } from "../playbook-view.js?v=96";
...
import { open as openAnalyzeProfilesModal } from "../components/analyze-profiles-modal.js?v=50";
...
import { sectionPatchFromAnalysis } from "../context-builder.js?v=373";
