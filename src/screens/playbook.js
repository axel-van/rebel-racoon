...
import { getContextById, getContexts, updateContext, deleteContext } from "../contexts-store.js?v=66";
import { mount, snapshotEditable } from "../playbook-view.js?v=88";
...
import { open as openAnalyzeProfilesModal } from "../components/analyze-profiles-modal.js?v=42";
...
import { sectionPatchFromAnalysis } from "../context-builder.js?v=330";
