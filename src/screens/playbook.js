...
import { getContextById, getContexts, updateContext, deleteContext } from "../contexts-store.js?v=64";
import { mount, snapshotEditable } from "../playbook-view.js?v=85";
...
import { open as openAnalyzeProfilesModal } from "../components/analyze-profiles-modal.js?v=40";
...
import { sectionPatchFromAnalysis } from "../context-builder.js?v=323";
