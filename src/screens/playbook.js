...
import { mount, snapshotEditable } from "../playbook-view.js?v=61";
...
import { open as openAnalyzeProfilesModal } from "../components/analyze-profiles-modal.js?v=22";
...
import { sectionPatchFromAnalysis } from "../context-builder.js?v=256";
