...
import { getContextById, getContexts, updateContext, deleteContext } from "../contexts-store.js?v=81";
import { mount, snapshotEditable } from "../playbook-view.js?v=104";
...
import { open as openAnalyzeProfilesModal } from "../components/analyze-profiles-modal.js?v=56";
...
import { sectionPatchFromAnalysis } from "../context-builder.js?v=437";
