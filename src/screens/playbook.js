...
import { getContextById, getContexts, updateContext, deleteContext } from "../contexts-store.js?v=78";
import { mount, snapshotEditable } from "../playbook-view.js?v=101";
...
import { open as openAnalyzeProfilesModal } from "../components/analyze-profiles-modal.js?v=53";
...
import { sectionPatchFromAnalysis } from "../context-builder.js?v=413";
