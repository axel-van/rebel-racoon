...
import { getContextById, getContexts, updateContext, deleteContext } from "../contexts-store.js?v=62";
import { mount, snapshotEditable } from "../playbook-view.js?v=80";
...
import { open as openAnalyzeProfilesModal } from "../components/analyze-profiles-modal.js?v=38";
...
import { sectionPatchFromAnalysis } from "../context-builder.js?v=310";
