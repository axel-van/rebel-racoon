...
import { getContextById, getContexts, updateContext, deleteContext } from "../contexts-store.js?v=60";
import { mount, snapshotEditable } from "../playbook-view.js?v=77";
...
import { open as openAnalyzeProfilesModal } from "../components/analyze-profiles-modal.js?v=37";
...
import { sectionPatchFromAnalysis } from "../context-builder.js?v=303";
