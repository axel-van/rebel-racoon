...
import { renderTopicCard } from "../components/topic-card.js?v=22";
import { open as openTopicModal } from "../components/topic-modal.js?v=30";
...
import { openTopicInChat } from "../topic-flow.js?v=27";
import {
  getTopics,
  getUnseenCount,
  dismissTopic,
