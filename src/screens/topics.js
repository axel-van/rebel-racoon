...
import { renderTopicCard } from "../components/topic-card.js?v=20";
import { open as openTopicModal } from "../components/topic-modal.js?v=28";
...
import { openTopicInChat } from "../topic-flow.js?v=25";
import {
  getTopics,
  getUnseenCount,
  dismissTopic,
