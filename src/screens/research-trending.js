...
import { renderBriefCard } from "../components/brief-card.js?v=32";
import { openFullResearch } from "../components/research-modals.js?v=57";
import { openBriefInChat } from "../brief-flow.js?v=8";
import { getLaneById } from "../research-store.js?v=28";
import { getAttentionForLane, setStatus, subscribe as subscribeBriefs } from "../briefs-store.js?v=35";
import { findResearchSource, findCadence } from "../research-catalog.js?v=14";
