...
import { openFullResearch } from "../components/research-modals.js?v=54";
import { openBriefInChat } from "../brief-flow.js?v=7";
import { getLaneById } from "../research-store.js?v=27";
import { getAttentionForLane, setStatus, subscribe as subscribeBriefs } from "../briefs-store.js?v=34";
