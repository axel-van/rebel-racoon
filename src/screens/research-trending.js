...
import { openFullResearch } from "../components/research-modals.js?v=71";
import { openBriefInChat } from "../brief-flow.js?v=11";
import { getLaneById } from "../research-store.js?v=31";
import { getAttentionForLane, setStatus, subscribe as subscribeBriefs } from "../briefs-store.js?v=38";
