...
import { initTopbar, renderTopbar } from "./components/topbar.js?v=36";
import { initSidebar, renderSidebar } from "./components/sidebar.js?v=29";
...
import { renderSession } from "./screens/session.js?v=69";
