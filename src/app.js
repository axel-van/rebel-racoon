...
import { initTopbar, renderTopbar } from "./components/topbar.js?v=185";
import { initSidebar, renderSidebar } from "./components/sidebar.js?v=157";
import { init as initRightPanel } from "./components/right-panel.js?v=284";
import { init as initScheduleModal } from "./components/schedule-modal.js?v=52";
...
import { init as initGenerateImageModal } from "./components/generate-image-modal.js?v=36";
import { init as initVideoClipsModal } from "./components/video-clips-modal.js?v=49";
import { init as initChatPickerModal } from "./components/chat-picker-modal.js?v=53";
import { init as initAddSourceModal } from "./components/add-source-modal.js?v=58";
import { init as initConnectorsModal } from "./components/connectors-modal.js?v=9";
...
import { init as initSaveFolderModal } from "./components/save-folder-modal.js?v=7";
import { init as initAnalyzeProfilesModal } from "./components/analyze-profiles-modal.js?v=11";
import { init as initFillDocumentModal } from "./components/fill-document-modal.js?v=5";
import { init as initSearchModal } from "./components/search-modal.js?v=6";
import {
  init as initConversationStatusCard,
  render as renderConversationStatusCard,
} from "./components/conversation-status-card.js?v=117";
import { renderDashboard } from "./screens/dashboard.js?v=49";
import { renderSession } from "./screens/session.js?v=396";
import { renderIdeas } from "./screens/ideas.js?v=140";
import { renderContexts } from "./screens/contexts.js?v=149";
import { renderConnectors } from "./screens/connectors.js?v=88";
...
import { renderWelcomeAltRecap } from "./screens/welcome-alt-recap.js?v=142";
import { renderPlaybook } from "./screens/playbook.js?v=153";
import * as __capAddSource from "./components/add-source-modal.js?v=58";
import * as __capGenImage from "./components/generate-image-modal.js?v=36";
...
import * as __capChatPicker from "./components/chat-picker-modal.js?v=53";
import * as __capSearch from "./components/search-modal.js?v=6";
import {
