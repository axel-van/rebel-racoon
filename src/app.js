...
import { initSidebar, renderSidebar } from "./components/sidebar.js?v=26";
import { init as initRightPanel } from "./components/right-panel.js?v=33";
...
import { renderSession } from "./screens/session.js?v=60";
