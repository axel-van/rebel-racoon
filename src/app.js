...
import { initTopbar, renderTopbar } from "./components/topbar.js?v=329";
import { initSidebar, renderSidebar } from "./components/sidebar.js?v=296";
import { init as initRightPanel } from "./components/right-panel.js?v=463";
...
import { init as initImageStudioModal } from "./components/image-studio/index.js?v=87";
import { init as initImageStudioV2Modal } from "./components/image-studio-v2/index.js?v=65";
...
import { init as initConnectorsModal } from "./components/connectors-modal.js?v=27";
import { init as initTopicModal } from "./components/topic-modal.js?v=19";
import { init as initResearchModals } from "./components/research-modals.js?v=43";
...
import { init as initAnalyzeProfilesModal } from "./components/analyze-profiles-modal.js?v=33";
import { init as initFillDocumentModal } from "./components/fill-document-modal.js?v=5";
import { init as initSearchModal } from "./components/search-modal.js?v=27";
import {
  init as initConversationStatusCard,
  render as renderConversationStatusCard,
} from "./components/conversation-status-card.js?v=256";
import { renderDashboard } from "./screens/dashboard.js?v=70";
import { renderSession } from "./screens/session.js?v=561";
import { renderContexts } from "./screens/contexts.js?v=290";
import { renderConnectors } from "./screens/connectors.js?v=229";
import { renderTopics } from "./screens/topics.js?v=98";
import { renderTopicsSettings } from "./screens/topics-settings.js?v=89";
import { renderResearch } from "./screens/research.js?v=64";
import { renderResearchForm } from "./screens/research-form.js?v=64";
import { renderResearchFeed } from "./screens/research-feed.js?v=72";
import { renderResearchTrending } from "./screens/research-trending.js?v=69";
...
import { renderWelcomeAltRecap } from "./screens/welcome-alt-recap.js?v=284";
import { renderPlaybook } from "./screens/playbook.js?v=298";
import * as __capAddSource from "./components/add-source-modal.js?v=81";
...
import * as __capChatPicker from "./components/chat-picker-modal.js?v=80";
import * as __capSearch from "./components/search-modal.js?v=27";
import {
