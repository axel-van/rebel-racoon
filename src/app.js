...
import { initTopbar, renderTopbar } from "./components/topbar.js?v=52";
import { initSidebar, renderSidebar } from "./components/sidebar.js?v=42";
import { init as initRightPanel } from "./components/right-panel.js?v=69";
import { init as initScheduleModal } from "./components/schedule-modal.js?v=22";
...
import { init as initGenerateImageModal } from "./components/generate-image-modal.js?v=22";
...
import { init as initChatPickerModal } from "./components/chat-picker-modal.js?v=22";
