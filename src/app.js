...
import { initTopbar, renderTopbar } from "./components/topbar.js?v=201";
import { initSidebar, renderSidebar } from "./components/sidebar.js?v=172";
import { init as initRightPanel } from "./components/right-panel.js?v=339";
...
import { init as initImageStudioModal } from "./components/image-studio/index.js?v=25";
...
import { init as initConnectorsModal } from "./components/connectors-modal.js?v=11";
...
import { init as initSaveFolderModal } from "./components/save-folder-modal.js?v=9";
import { init as initAnalyzeProfilesModal } from "./components/analyze-profiles-modal.js?v=13";
import { init as initFillDocumentModal } from "./components/fill-document-modal.js?v=5";
import { init as initSearchModal } from "./components/search-modal.js?v=9";
import {
  init as initConversationStatusCard,
  render as renderConversationStatusCard,
} from "./components/conversation-status-card.js?v=132";
import { renderDashboard } from "./screens/dashboard.js?v=52";
import { renderSession } from "./screens/session.js?v=424";
import { renderContexts } from "./screens/contexts.js?v=164";
import { renderConnectors } from "./screens/connectors.js?v=103";
...
import { renderWelcomeAltRecap } from "./screens/welcome-alt-recap.js?v=158";
import { renderPlaybook } from "./screens/playbook.js?v=169";
import * as __capAddSource from "./components/add-source-modal.js?v=61";
...
import * as __capChatPicker from "./components/chat-picker-modal.js?v=56";
import * as __capSearch from "./components/search-modal.js?v=9";
import {
