...
import { init as initRightPanel } from "./components/right-panel.js?v=111";
...
import { init as initVideoClipsModal } from "./components/video-clips-modal.js?v=3";
...
} from "./components/right-panel.js?v=111";
