...
import { initTopbar, renderTopbar } from "./components/topbar.js?v=195";
import { initSidebar, renderSidebar } from "./components/sidebar.js?v=166";
import { init as initRightPanel } from "./components/right-panel.js?v=309";
...
import { init as initImageStudioModal } from "./components/image-studio-modal.js?v=16";
...
import { init as initSearchModal } from "./components/search-modal.js?v=8";
import {
  init as initConversationStatusCard,
  render as renderConversationStatusCard,
} from "./components/conversation-status-card.js?v=126";
import { renderDashboard } from "./screens/dashboard.js?v=51";
import { renderSession } from "./screens/session.js?v=418";
import { renderContexts } from "./screens/contexts.js?v=158";
import { renderConnectors } from "./screens/connectors.js?v=97";
...
import { renderWelcomeAltRecap } from "./screens/welcome-alt-recap.js?v=152";
import { renderPlaybook } from "./screens/playbook.js?v=163";
...
import * as __capSearch from "./components/search-modal.js?v=8";
import {
