...
import { init as initPillarHistoryModal } from "./components/pillar-history-modal.js?v=2";
...
import { renderContentStrategy } from "./screens/content-strategy.js?v=34";
import { renderPillar } from "./screens/pillar.js?v=38";
