...
import { init as initRightPanel } from "./components/right-panel.js?v=60";
import { init as initScheduleModal } from "./components/schedule-modal.js?v=20";
import { initUserModeChip } from "./components/user-mode-chip.js?v=22";
...
import { renderSession } from "./screens/session.js?v=105";
