import { html, raw, escapeHtml, escapeAttr } from "../utils.js?v=1159";
import { getPath, navigate } from "../router.js?v=1159";
import { parseHashParams } from "../url-state.js?v=1159";
...
} from "./right-panel.js?v=1159";
import { getSources as getSessionSources, subscribeSources } from "../sources-stream.js?v=1159";
import { getThread, subscribe as subscribeThread } from "../assistant.js?v=1159";
import { getIdeas, subscribe as subscribeLibrary } from "../library.js?v=1159";
import { getPosts, subscribe as subscribePosts } from "../posts-store.js?v=1159";
import {
  isEnabled as isStatusCardEnabled,
  toggle as toggleStatusCard,
  subscribeVisibility as subscribeStatusCardVisibility,
} from "./conversation-status-card.js?v=1159";
import { getSessionById, updateSession, subscribe as subscribeSessions } from "../sessions-store.js?v=1159";
...
import { getActivePlaybook, isWorkspaceMode, isAccountScope, catalogueRoute } from "../active-playbook.js?v=1159";
import { getFeedForPlaybook } from "../topic-feeds-store.js?v=1159";
import { findCadence } from "../topics-catalog.js?v=1159";
import {
  getPickerState as getTopPostsState,
  subscribePicker as subscribeTopPosts,
  backToProfiles as topPostsBackToProfiles,
} from "../top-posts-flow.js?v=1159";
...
import { readLayoutId, viewSwitch } from "../screens/insights/views.js?v=1159";
...
export function initTopbar() {
  ...
  el.addEventListener("click", (event) => {
    ...
    if (event.target.closest("[data-topbar-welcome-alt-exit]")) {
      import("./confirm-modal.js?v=1159").then(({ open }) => {
        open({
...
function currentTitle() {
  const path = getPath();
  // Two homes, one word: `/` is the active brand's (a redirect that never
