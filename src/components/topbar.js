import { html, raw, escapeHtml, escapeAttr } from "../utils.js?v=1215";
import { getPath, navigate } from "../router.js?v=1215";
import { parseHashParams } from "../url-state.js?v=1215";
...
} from "./right-panel.js?v=1215";
import { getSources as getSessionSources, subscribeSources } from "../sources-stream.js?v=1215";
import { getThread, subscribe as subscribeThread } from "../assistant.js?v=1215";
import { getIdeas, subscribe as subscribeLibrary } from "../library.js?v=1215";
import { getPosts, subscribe as subscribePosts } from "../posts-store.js?v=1215";
import {
  isEnabled as isStatusCardEnabled,
  toggle as toggleStatusCard,
  subscribeVisibility as subscribeStatusCardVisibility,
} from "./conversation-status-card.js?v=1215";
import { getSessionById, updateSession, subscribe as subscribeSessions } from "../sessions-store.js?v=1215";
...
import { getActivePlaybook, isWorkspaceMode, isAccountScope, catalogueRoute } from "../active-playbook.js?v=1215";
import { getFeedForPlaybook } from "../topic-feeds-store.js?v=1215";
import { findCadence } from "../topics-catalog.js?v=1215";
import {
  getPickerState as getTopPostsState,
  subscribePicker as subscribeTopPosts,
  backToProfiles as topPostsBackToProfiles,
} from "../top-posts-flow.js?v=1215";
...
import { readLayoutId, viewSwitch } from "../screens/insights/views.js?v=1215";
...
export function initTopbar() {
  ...
  el.addEventListener("click", (event) => {
    ...
    if (event.target.closest("[data-topbar-welcome-alt-exit]")) {
      import("./confirm-modal.js?v=1215").then(({ open }) => {
        open({
