...
import { getPosts, attachImageToDraft, attachCarouselToDraft } from "../../posts-store.js?v=68";
import { getSessionById } from "../../sessions-store.js?v=39";
...
import { renderStudio } from "./shell-view.js?v=99";
import {
  openFilePicker,
  openLogoPicker,
  startOverlayGesture,
