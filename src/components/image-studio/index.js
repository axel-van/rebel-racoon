...
import { getPosts, attachImageToDraft, attachCarouselToDraft } from "../../posts-store.js?v=59";
import { getSessionById } from "../../sessions-store.js?v=29";
...
import { renderStudio } from "./shell-view.js?v=88";
import {
  openFilePicker,
  openLogoPicker,
  startOverlayGesture,
