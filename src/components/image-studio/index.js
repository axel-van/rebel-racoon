...
import { getPosts, attachImageToDraft, attachCarouselToDraft } from "../../posts-store.js?v=56";
import { getSessionById } from "../../sessions-store.js?v=26";
...
import { renderStudio } from "./shell-view.js?v=84";
import {
  openFilePicker,
  openLogoPicker,
  startOverlayGesture,
