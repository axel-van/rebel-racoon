...
import { getPosts, attachImageToDraft, attachCarouselToDraft } from "../../posts-store.js?v=57";
import { getSessionById } from "../../sessions-store.js?v=27";
...
import { renderStudio } from "./shell-view.js?v=85";
import {
  openFilePicker,
  openLogoPicker,
  startOverlayGesture,
