...
import { KEY, ctx } from "./context.js?v=8";
import { generateControls, deriveButton } from "./compose-view.js?v=11";
import { actionBar, toolPalette, editCanvas } from "./edit-view.js?v=22";
