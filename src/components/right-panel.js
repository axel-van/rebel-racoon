...
import { isSidebarCollapsed, setSidebarCollapsed } from "./sidebar.js?v=115";
import {
...
import { open as openAddSourceModal } from "./add-source-modal.js?v=51";
...
import { addMention as addComposerMention } from "../composer-mentions.js?v=13";
    ...
    if (sourceClipsBtn) {
      ...
      openVideoClipsModal(src, {
        ...
        onUseClips: (selectedClips, source) => {
          import("../screens/session.js?v=315").then(({ startClipDraftFlow }) => {
            startClipDraftFlow(
              sid,
...
function useIdea(ideaId) {
  ...
  const sid = activeSessionId();
  if (!sid) return;
  import("../screens/session.js?v=315").then(({ askAngleQuestion }) => {
