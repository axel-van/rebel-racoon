...
import { getThread, subscribe as subscribeThread } from "../assistant.js?v=47";
...
import { isSidebarCollapsed, setSidebarCollapsed } from "./sidebar.js?v=111";
import {
...
import { open as openAddSourceModal } from "./add-source-modal.js?v=49";
...
import { addMention as addComposerMention } from "../composer-mentions.js?v=11";
    ...
    if (sourceClipsBtn) {
      ...
      openVideoClipsModal(src, {
        ...
        onUseClips: (selectedClips, source) => {
          import("../screens/session.js?v=311").then(({ startClipDraftFlow }) => {
            startClipDraftFlow(
              sid,
...
function useIdea(ideaId) {
  ...
  const sid = activeSessionId();
  if (!sid) return;
  import("../screens/session.js?v=311").then(({ askAngleQuestion }) => {
