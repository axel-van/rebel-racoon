...
import { renderPostCard } from "./post-card.js?v=106";
import { renderTopPostEcho } from "./top-post-card.js?v=122";
import { renderClipCard } from "./clip-card.js?v=50";
...
import { open as openVideoClipsModal } from "./video-clips-modal.js?v=89";
import { isSidebarCollapsed, setSidebarCollapsed, isAutoCollapsed } from "./sidebar.js?v=362";
import {
...
import { open as openAddSourceModal } from "./add-source-modal.js?v=97";
...
import { addMention as addComposerMention } from "../composer-mentions.js?v=62";
...
import { open as openScheduleModal } from "./schedule-modal.js?v=90";
import { open as openImageStudioModal } from "./image-studio/index.js?v=105";
import { open as openImageStudioV2Modal } from "./image-studio-v2/index.js?v=83";
    ...
    if (sourceClipsBtn) {
      ...
      openVideoClipsModal(src, {
        ...
        onUseClips: (selectedClips, source) => {
          import("../screens/session.js?v=627").then(({ startClipDraftFlow }) => {
            startClipDraftFlow(
              sid,
...
function useIdea(ideaId) {
  ...
  const sid = activeSessionId();
  if (!sid) return;
  import("../screens/session.js?v=627").then(({ askAngleQuestion }) => {
