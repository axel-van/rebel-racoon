...
import { renderTopPostEcho } from "./top-post-card.js?v=72";
import { renderClipCard } from "./clip-card.js?v=20";
...
import { open as openVideoClipsModal } from "./video-clips-modal.js?v=60";
import { isSidebarCollapsed, setSidebarCollapsed, isAutoCollapsed } from "./sidebar.js?v=221";
import {
...
import { open as openAddSourceModal } from "./add-source-modal.js?v=67";
...
import { addMention as addComposerMention } from "../composer-mentions.js?v=32";
...
import { open as openScheduleModal } from "./schedule-modal.js?v=60";
import { open as openImageStudioModal } from "./image-studio/index.js?v=53";
import { open as openImageStudioV2Modal } from "./image-studio-v2/index.js?v=21";
    ...
    if (sourceClipsBtn) {
      ...
      openVideoClipsModal(src, {
        ...
        onUseClips: (selectedClips, source) => {
          import("../screens/session.js?v=473").then(({ startClipDraftFlow }) => {
            startClipDraftFlow(
              sid,
...
function useIdea(ideaId) {
  ...
  const sid = activeSessionId();
  if (!sid) return;
  import("../screens/session.js?v=473").then(({ askAngleQuestion }) => {
