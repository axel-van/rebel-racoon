...
import { renderTopPostEcho } from "./top-post-card.js?v=129";
import { renderClipCard } from "./clip-card.js?v=54";
...
import { isSidebarCollapsed, setSidebarCollapsed, isAutoCollapsed } from "./sidebar.js?v=403";
import {
...
import { open as openAddSourceModal } from "./add-source-modal.js?v=101";
...
import { addMention as addComposerMention } from "../composer-mentions.js?v=66";
    ...
    if (sourceClipsBtn) {
      ...
      openVideoClipsModal(src, {
        ...
        onUseClips: (selectedClips, source) => {
          import("../screens/session.js?v=668").then(({ startClipDraftFlow }) => {
            startClipDraftFlow(
              sid,
...
function useIdea(ideaId) {
  ...
  const sid = activeSessionId();
  if (!sid) return;
  import("../screens/session.js?v=668").then(({ askAngleQuestion }) => {
