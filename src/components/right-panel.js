...
import { getThread, subscribe as subscribeThread } from "../assistant.js?v=74";
import { isFlagOn } from "../feature-flags.js?v=18";
import { ideas as MOCK_IDEAS } from "../mocks.js?v=71";
...
} from "../posts-store.js?v=48";
import { renderPostCard } from "./post-card.js?v=86";
import { renderTopPostEcho } from "./top-post-card.js?v=83";
import { renderClipCard } from "./clip-card.js?v=30";
...
import { open as openVideoClipsModal } from "./video-clips-modal.js?v=70";
import { isSidebarCollapsed, setSidebarCollapsed, isAutoCollapsed } from "./sidebar.js?v=265";
import {
...
import { open as openAddSourceModal } from "./add-source-modal.js?v=77";
import { open as openRenameModal } from "./rename-modal.js?v=2";
import { getConnectedConnectors } from "../connectors-store.js?v=40";
import { askConnector } from "../connector-ask.js?v=20";
import { renderConnectorLogo } from "../connectors-view.js?v=22";
import { open as openConnectorsModal } from "./connectors-modal.js?v=23";
import { addMention as addComposerMention } from "../composer-mentions.js?v=42";
...
import { open as openScheduleModal } from "./schedule-modal.js?v=70";
import { open as openImageStudioModal } from "./image-studio/index.js?v=82";
import { open as openImageStudioV2Modal } from "./image-studio-v2/index.js?v=60";
    ...
    if (sourceClipsBtn) {
      ...
      openVideoClipsModal(src, {
        ...
        onUseClips: (selectedClips, source) => {
          import("../screens/session.js?v=505").then(({ startClipDraftFlow }) => {
            startClipDraftFlow(
              sid,
...
function useIdea(ideaId) {
  ...
  const sid = activeSessionId();
  if (!sid) return;
  import("../screens/session.js?v=505").then(({ askAngleQuestion }) => {
