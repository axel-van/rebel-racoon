...
import { ideas as MOCK_IDEAS } from "../mocks.js?v=65";
...
import { isSidebarCollapsed, setSidebarCollapsed, isAutoCollapsed } from "./sidebar.js?v=252";
import {
...
import { open as openImageStudioModal } from "./image-studio/index.js?v=74";
import { open as openImageStudioV2Modal } from "./image-studio-v2/index.js?v=52";
    ...
    if (sourceClipsBtn) {
      ...
      openVideoClipsModal(src, {
        ...
        onUseClips: (selectedClips, source) => {
          import("../screens/session.js?v=504").then(({ startClipDraftFlow }) => {
            startClipDraftFlow(
              sid,
...
function useIdea(ideaId) {
  ...
  const sid = activeSessionId();
  if (!sid) return;
  import("../screens/session.js?v=504").then(({ askAngleQuestion }) => {
