...
import { connectorDocs } from "../mocks.js?v=1217";
import {
  getConnectors,
  findConnector,
  setConnectorStatus,
  subscribe as subscribeConnectors,
} from "../connectors-store.js?v=1217";
import { postConnectPrompt } from "../assistant.js?v=1217";
import { URL_SERVICES, detectUrlService } from "../url-services.js?v=1217";
...
import { dropzoneHTML } from "./dropzone.js?v=1217";
