...
import { getIdeas, clearSession as clearLibrarySession } from "../library.js?v=43";
...
import { closePanel as closeRightPanel } from "./right-panel.js?v=277";
...
import { clearSession as clearSourcesSession } from "../sources-stream.js?v=45";
