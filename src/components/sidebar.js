...
import { open as openSearchModal } from "./search-modal.js?v=17";
...
import { getLanes, subscribe as subscribeLanes } from "../research-store.js?v=3";
import { closePanel as closeRightPanel } from "./right-panel.js?v=420";
