...
import { getIdeas, clearSession as clearLibrarySession } from "../library.js?v=37";
...
import { closePanel as closeRightPanel } from "./right-panel.js?v=195";
import { clearSession as clearAssistantSession } from "../assistant.js?v=47";
