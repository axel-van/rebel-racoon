...
import { navigate, getPath } from "../router.js?v=1222";
import { open as openBugReportModal } from "./bug-report-modal.js?v=1222";
import { open as openFeedbackModal } from "./feedback-modal.js?v=1222";
import { open as openConfirmModal } from "./confirm-modal.js?v=1222";
import { open as openRenameModal } from "./rename-modal.js?v=1222";
import { open as openSearchModal } from "./search-modal.js?v=1222";
import { toggle as toggleShortcutLegend } from "./shortcut-legend.js?v=1222";
import { renderAdminMenu, applyUserMode, applyOrgRole, toggleFlag } from "../admin-menu.js?v=1222";
import {
  getSessions,
  getSessionById,
  updateSession,
...
} from "../sessions-store.js?v=1222";
import { isFlagOn } from "../feature-flags.js?v=1222";
import { isNewUser } from "../user-mode.js?v=1222";
import { clearSession as clearLibrarySession } from "../library.js?v=1222";
import { getContextById, subscribe as subscribeContexts } from "../contexts-store.js?v=1222";
import {
  getActivePlaybook,
  setActivePlaybook,
  isWorkspaceMode,
...
} from "../active-playbook.js?v=1222";
import { setHandoff } from "../handoff.js?v=1222";
...
import { canView, visibleContexts } from "../playbook-access.js?v=1222";
import { getFeedForPlaybook } from "../topic-feeds-store.js?v=1222";
import { countToReview, subscribe as subscribeTopics } from "../topics-store.js?v=1222";
import { getConnectedConnectors, subscribe as subscribeConnectors } from "../connectors-store.js?v=1222";
import { closePanel as closeRightPanel } from "./right-panel.js?v=1222";
import { clearSession as clearAssistantSession } from "../assistant.js?v=1222";
import { clearSession as clearPostsSession } from "../posts-store.js?v=1222";
import { clearSession as clearSourcesSession } from "../sources-stream.js?v=1222";
...
function deleteSidebarSession(sessionId) {
  ...
  openConfirmModal({
    ...
    onConfirm: () => {
      ...
      import("./toast.js?v=1222").then(({ showToast }) => showToast("Chat deleted"));
    },
  });
}
