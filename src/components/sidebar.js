...
import { getLanes, subscribe as subscribeLanes } from "../research-store.js?v=17";
import { closePanel as closeRightPanel } from "./right-panel.js?v=436";
