...
import { open as openSearchModal } from "./search-modal.js?v=23";
...
import { getLanes, subscribe as subscribeLanes } from "../research-store.js?v=15";
import { closePanel as closeRightPanel } from "./right-panel.js?v=434";
