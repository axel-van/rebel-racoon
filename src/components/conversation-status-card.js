...
import { getPath } from "../router.js?v=1208";
import {
...
import { subscribe as subscribeSessions } from "../sessions-store.js?v=1208";
import { addMention } from "../composer-mentions.js?v=1208";
