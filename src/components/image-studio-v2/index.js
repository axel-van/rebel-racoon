...
import { requestOpen, notifyClose, bindOverlayDismissal } from "../../modal-coordinator.js?v=1155";
...
import { MODAL_ID, KEY, ctx, state, autosize } from "./context.js?v=1155";
import { loadImg } from "../../image-studio-canvas.js?v=1155";
import { renderStudio } from "./stage-view.js?v=1155";
import { offerUndoIfNeeded, resetUndoOffers } from "./prompt-guard.js?v=1155";
import { bindStudioEvents } from "./events.js?v=1155";
