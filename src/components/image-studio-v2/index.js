...
import { requestOpen, notifyClose, bindOverlayDismissal } from "../../modal-coordinator.js?v=1171";
...
import { MODAL_ID, KEY, ctx, state, autosize } from "./context.js?v=1171";
import { loadImg } from "../../image-studio-canvas.js?v=1171";
import { renderStudio } from "./stage-view.js?v=1171";
import { offerUndoIfNeeded, resetUndoOffers } from "./prompt-guard.js?v=1171";
import { bindStudioEvents } from "./events.js?v=1171";
