...
import { KEY, ctx } from "./context.js?v=14";
import { composer, settingsPanel, toolPalette, footerBar } from "./composer-view.js?v=25";
import { editCanvas } from "./edit-view.js?v=14";
