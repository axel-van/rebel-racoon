...
import { KEY, ctx } from "./context.js?v=10";
import { composer, settingsPanel, toolPalette, footerBar } from "./composer-view.js?v=15";
import { editCanvas } from "./edit-view.js?v=10";
