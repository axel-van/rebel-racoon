...
import { KEY, ctx } from "./context.js?v=23";
import { composer, settingsPanel, toolPalette, footerBar } from "./composer-view.js?v=38";
import { editCanvas } from "./edit-view.js?v=23";
