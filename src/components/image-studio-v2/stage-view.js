...
import { composer } from "./composer-view.js?v=1222";
import { setupStage } from "./setup-stage.js?v=1222";
import { toolPalette } from "./tools-view.js?v=1222";
import { promptGuardDialog } from "./prompt-guard.js?v=1222";
import { editCanvas } from "./edit-view.js?v=1222";
import { compositeOverlays } from "../../image-studio-canvas.js?v=1222";
