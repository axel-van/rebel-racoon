...
import { NETWORK_LABEL, NETWORK_ICON_BY_PLATFORM } from "../../social-profiles.js?v=40";
import { renderPostCard } from "../post-card.js?v=84";
import { KEY, ctx } from "./context.js?v=35";
import { composer, settingsPanel, toolPalette, footerBar } from "./composer-view.js?v=60";
import { editCanvas } from "./edit-view.js?v=35";
