...
import { KEY, ctx } from "./context.js?v=16";
import { composer, settingsPanel, toolPalette, footerBar } from "./composer-view.js?v=27";
import { editCanvas } from "./edit-view.js?v=16";
