...
import { KEY, ctx } from "./context.js?v=32";
import { composer, settingsPanel, toolPalette, footerBar } from "./composer-view.js?v=57";
import { editCanvas } from "./edit-view.js?v=32";
