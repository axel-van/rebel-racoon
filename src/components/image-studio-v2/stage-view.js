...
import { KEY, ctx } from "./context.js?v=1209";
import { composer } from "./composer-view.js?v=1209";
import { setupStage } from "./setup-stage.js?v=1209";
import { toolPalette } from "./tools-view.js?v=1209";
import { promptGuardDialog } from "./prompt-guard.js?v=1209";
import { editCanvas } from "./edit-view.js?v=1209";
