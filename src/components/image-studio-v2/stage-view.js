...
import { KEY, ctx } from "./context.js?v=1213";
import { composer } from "./composer-view.js?v=1213";
import { setupStage } from "./setup-stage.js?v=1213";
import { toolPalette } from "./tools-view.js?v=1213";
import { promptGuardDialog } from "./prompt-guard.js?v=1213";
import { editCanvas } from "./edit-view.js?v=1213";
