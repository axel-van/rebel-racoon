...
import { KEY, ctx } from "./context.js?v=11";
import { composer, settingsPanel, toolPalette, footerBar } from "./composer-view.js?v=16";
import { editCanvas } from "./edit-view.js?v=11";
