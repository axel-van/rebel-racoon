...
import { KEY, ctx } from "./context.js?v=31";
import { composer, settingsPanel, toolPalette, footerBar } from "./composer-view.js?v=56";
import { editCanvas } from "./edit-view.js?v=31";
