...
import { KEY, ctx } from "./context.js?v=36";
import { composer, settingsPanel, toolPalette, footerBar } from "./composer-view.js?v=61";
import { editCanvas } from "./edit-view.js?v=36";
