...
import { openPillarInChat } from "./pillar-flow.js?v=22";
...
import { NETWORK_ICON_BY_PLATFORM, NETWORK_LABEL } from "./social-profiles.js?v=70";
  ...
  if (pillarRemove) {
    ...
    openConfirmModal({
      ...
      body:
        ...
        `You can add it back anytime from the Used cards in the Topic Feed.`,
