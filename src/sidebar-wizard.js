...
import { chatTurn, bulletsBlock, fieldsBlock, summarySections } from "./screens/_analyse-common.js?v=33";
import { voiceAnalysis, strategyBrief, brandTheme } from "./mocks.js?v=35";
