...
import { chatTurn, bulletsBlock, fieldsBlock, summarySections } from "./screens/_analyse-common.js?v=29";
import { voiceAnalysis, strategyBrief, brandTheme } from "./mocks.js?v=31";
