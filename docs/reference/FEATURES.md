...
| 6   | La tuile fantôme est un **`<button>` entier** dans la forme de « Create a Playbook »                                                                                                                    | ✅ `BUTTON`, 195px, glyphe Archie + titre + sous-titre centrés                                   |
| 7   | Kebab de carte : Rename · **Merge into <chaque autre pilier du même Playbook>** · Delete ; suppression avec confirmation                                                                                | ✅                                                                                               |
...
| 16  | Le dialog **New pillar** demande nom + Playbook + sujet, porte l'infobox « You don't have to fill this », **aucun** sélecteur de seed, et crée le pilier                                                | ✅ 4 champs ; Create désactivé tant que le nom est vide ; carte ajoutée                          |
...
| 18  | Le kebab de carte ouvre Use in chat · Save for later · Unlink from this pillar · Ignore ; **Unlink** retire la marque sans toucher à la piste                                                           | ✅ 3 → 2 marques ; toast nommant le pilier                                                       |
