...
- **Empty states** — trois culs-de-sac distincts : rien d'activé nulle part (**« Tell me what to watch »** → bascule sur l'onglet **What I watch**, l'endroit qui règle le problème), filtre sans résultat, feed vidé à la main (**« Nothing new right now »** + la cadence la plus rapide). Précédence voulue : neuf dossiers avec zéro source active affichent quand même le feed — les dossiers sont toujours là à lire.
