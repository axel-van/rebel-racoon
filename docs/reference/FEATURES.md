...
- **Rename + Delete en panneau au survol** (`.research-card__hover`), comme la carte de feed — ce qui a du même coup retiré le kebab et son menu. **Merge est retiré pour l'instant** ; quand il reviendra il lui faudra un sélecteur de cible, donc il ne tiendra pas dans un panneau à deux icônes et le menu reviendra avec lui.
