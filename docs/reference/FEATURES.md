...
| `sidebarOrganize`        | Sort & group chats             | **OFF** | Bouton filtre au-dessus de la liste des chats → popover **Group by** (Aucun / Playbook) + **Sort by** (Récence / Alphabétique) ; réordonne/regroupe la liste (Pinned reste en tête). Préf. persistée (`archie-chat-organize`). |
